            ...
            Padding(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    const Padding(
                      padding: EdgeInsets.only(top: 15), // Naikkan nilainya untuk menurunkan posisi ikon
                      child: Icon(
                        Icons.info_outline,
                        color: Colors.white,
                      ...
                      child: Text.rich(
                        TextSpan(
                          children: [
                            TextSpan(
                              text:
                              'The item will be delivered soon\nplease stay at the location.',
                              style: TextStyle(
                                color: Colors.white,
                                fontWeight: FontWeight.bold,
                                height: 2, // Tambahkan ini untuk menurunkan tulisan
                              ),
                            ),
                          ],
                        ),
